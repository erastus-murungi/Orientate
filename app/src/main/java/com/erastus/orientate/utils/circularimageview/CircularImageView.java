package com.erastus.orientate.utils.circularimageview;
...
//        super(context, attrs, defStyleAttr, defStyleRes);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if(hasSelector && isSelected) { // Draw the selector stroke & apply the selector filter, if applicable
            ...
            canvas.drawCircle(center + outerWidth, center + outerWidth, ((canvasSize - (outerWidth * 2f)) / 2f) + outerWidth - 4.0f, paintSelectorBorder);
        }
            ...
            RectF rekt = new RectF(0f + outerWidth / 2f, 0f + outerWidth / 2f, canvasSize - outerWidth / 2f, canvasSize - outerWidth / 2f);
